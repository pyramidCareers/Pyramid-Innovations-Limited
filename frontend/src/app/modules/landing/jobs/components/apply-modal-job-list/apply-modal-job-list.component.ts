...
@Component({
    selector: 'app-apply-modal-job-list',
    templateUrl: './apply-modal-job-list.component.html',
    styleUrls: ['./apply-modal-job-list.component.scss'],
})
export class ApplyModalJobListComponent {
    constructor(
        public dialogRef: MatDialogRef<ApplyModalJobListComponent>,
